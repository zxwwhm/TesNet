...
#         ("coco_test_base", "coco/trainval2014", "cocosplit/datasplit/trainvalno5k.json"),
        ("coco_test_base", "coco/val2014", "cocosplit/datasplit/5k.json"),
        ("coco_test_novel", "coco/val2014", "cocosplit/datasplit/5k.json"),
#         ("coco_trainval_all_5shot","coco/train"
        # ("coco_test_novel","coco/trainval2014","cocosplit/datasplit/5shot.json"),
#         ("coco_test_novel","coco/trainval2014","cocosplit/datasplit/10shot_novel.json"),
    ]
...
#             name = "coco_trainval_{}_{}shot".format(prefix, shot)
...
#             for shot in [1, 2, 3, 5, 10]:
#                 for year in [2007,2012]:
#                     name="voc_{}_test_{}{}_{}shot".format(
#                         year,prefix,sid,shot
#                     )
#                     dirname="VOC{}".format(year)
#                     img_file="{}_{}shot_split_{}_trainval".format(
#                         prefix,shot,sid
