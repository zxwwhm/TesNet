...
from fsdet.data.datasets.builtin_meta import _get_builtin_metadata
meta_data_5shot_trainval = _get_builtin_metadata("coco_fewshot")
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        print("precision",precisions.shape)
        # print("iou",precisions[0,:])
