...
class RPN(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        self.cnt = 0
        self.detailFile = open("detail.txt", "w")
        self.totalFile = open("total.txt", "w")
        self.result0 = {}
        self.result1 = {}
        self.totalResult0 = {}
        self.totalResult1 = {}
        self.jsonResult = {}
        self.jsonResult['zero'] = []
        self.jsonResult['one'] = []
        ...
        self.pre_nms_topk = {
            ...
            # True: cfg.MODEL.RPN.PRE_NMS_TOPK_TEST,
            False: cfg.MODEL.RPN.PRE_NMS_TOPK_TEST,
        }
        self.post_nms_topk = {
            True: cfg.MODEL.RPN.POST_NMS_TOPK_TRAIN,
            # True: cfg.MODEL.RPN.POST_NMS_TOPK_TEST,
