...
def find_top_rpn_proposals(
    ...
    for level_id, proposals_i, logits_i in zip(
        ...
        num_proposals_i =int( min(pre_nms_topk, Hi_Wi_A))
...
class RPNOutputs(object):
    ...
    #         # print("gt_objectness_logits_i: ", gt_objectness_logits_i)
    ...
    #     return gt_objectness_logits, matched_idxs
