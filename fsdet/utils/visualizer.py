...
#             assigned_colors = [[0,0,0] for _ in range(num_instances)]
        if num_instances == 0:
            return self.output
        ...
        for i in range(num_instances):
            ...
            if labels is not None:
                ...
                if boxes is not None:
                    x0, y0, x1, y1 = boxes[i]
                    text_pos = (x0, y0)  # if drawing boxes, put text on the box corner. x0 y0
                    horiz_align = "left"
                else:
                    continue
...
#                     text_pos = (x1, y0)
    ...
    def draw_text(
        ...
        *,
        ...
        self.output.ax.text(
            ...
            family="sans-serif",
            bbox={"facecolor": color, "alpha": 1, "pad": 0.7, "edgecolor": "none"}, #0.8
    ...
    def draw_box(self, box_coord, alpha=1, edge_color="g", line_style="-"): #0.5
        """
        Args:
    ...
    def draw_rotated_box_with_label(
        self, rotated_box, alpha=1, edge_color="g", line_style="-", label=None #0.5
    ):
        """
        Args:
